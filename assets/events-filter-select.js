class EventsFilterSelect {
  constructor(container) {
    ...
    this.checkboxes = Array.from(container.querySelectorAll('[data-filter-select-checkbox]'))
    this.hiddenInputsContainer = container.querySelector('[data-filter-select-hidden-inputs]')
